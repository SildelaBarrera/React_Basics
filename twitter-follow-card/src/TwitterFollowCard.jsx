...
export function TwitterFollowCard ({children, formatUserName, userName = 'unknown', avatar, initialIsFollowing }) {
    ...
    // lo que va en los paréntesis es el valor inicial que quieres (puede ser true o false, o una props)
